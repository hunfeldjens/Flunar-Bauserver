...
![Version](https://img.shields.io/badge/Version-3.2.0-1FADFF?style=for-the-badge)
...
3. `target/Flunar-Bauserver-3.2.0.jar` in den `plugins`-Ordner des Servers kopieren.
